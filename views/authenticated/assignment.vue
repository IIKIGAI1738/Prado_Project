...
<template>
    <main class="flex-1 px-4 sm:px-6 lg:px-8 py-6 space-y-8">
        ...
        <section class="bg-white rounded-lg shadow p-6">
          ...
          <div class="space-y-4">
            <!-- Assignment card -->
            <div class="flex items-start justify-between bg-gray-50 p-4 rounded-md">
              <div>
                <h3 class="font-medium text-gray-800">Calculus Homework#3</h3>
                <p class="text-sm text-gray-500">Mathematics – Due Aug5, 2025</p>
                <p class="text-sm text-gray-600 mt-1">Complete exercises 7–12 on page143 of the textbook.</p>
              </div>
            ...
            <div class="flex items-start justify-between bg-gray-50 p-4 rounded-md">
              <div>
                <h3 class="font-medium text-gray-800">Group Project Proposal</h3>
                <p class="text-sm text-gray-500">Computer Science – Due Aug10, 2025</p>
            ...
            <div class="flex items-start justify-between bg-gray-50 p-4 rounded-md">
              <div>
                <h3 class="font-medium text-gray-800">Reading Response</h3>
                <p class="text-sm text-gray-500">English Literature – Due Aug12, 2025</p>
        ...
        <section class="bg-white rounded-lg shadow p-6">
          ...
          <div class="space-y-4">
            <div class="flex items-start justify-between bg-gray-50 p-4 rounded-md">
              <div>
                <h3 class="font-medium text-gray-800">Physics Lab Report</h3>
                <p class="text-sm text-gray-500">Physics – Submitted Jul29, 2025</p>
                <p class="text-sm text-gray-600 mt-1">Experiment on projectile motion with detailed data analysis.</p>
              </div>
              <div class="flex flex-col items-end space-y-2">
            ...
            <div class="flex items-start justify-between bg-gray-50 p-4 rounded-md">
              <div>
                <h3 class="font-medium text-gray-800">Essay on Climate Change</h3>
                <p class="text-sm text-gray-500">Environmental Science – Submitted Jul22, 2025</p>
            ...
            <div class="flex items-start justify-between bg-gray-50 p-4 rounded-md">
              <div>
                <h3 class="font-medium text-gray-800">Programming Assignment #2</h3>
                <p class="text-sm text-gray-500">Programming101 – Submitted Jul18, 2025</p>
