...
<template>
    <div class="bg-gray-100 text-gray-800 antialiased">
        ...
        <div class="pt-16 max-w-7xl mx-auto flex flex-col lg:flex-row">
            ...
            <!-- Right Sidebar -->
            <aside
                class="hidden xl:flex xl:flex-col xl:w-72 border-l border-gray-50 bg-white px-4 py-6 space-y-8"
            >
                <!-- Profile card -->
                <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
                    <div class="flex items-center space-x-3">
                        ...
                        />
                        <div>
                            <h4 class="font-semibold text-gray-800">IKIGAI</h4>
                            <p class="text-sm text-gray-500">Computer Science, Class of 2026</p>
                        </div>
                    </div>
                    <div class="mt-4 text-gray-600 text-sm leading-snug">
                        Welcome back! Here’s your quick overview: 3 new messages, 2 upcoming
                ...
                <div class="flex-1 flex flex-col">
                    ...
                    <div
                        class="mt-4 bg-gray-50 border border-gray-50 rounded-md flex flex-col h-64"
                    >
                        <div
                        ...
                        <div class="flex-1 p-3 space-y-2 overflow-y-auto">
                            ...
                            <div class="flex justify-end">
                                <div
                                    class="bg-indigo-600 text-white rounded-md p-2 max-w-xs shadow text-sm"
                                >
        ...
        >
            <div
                class="bg-gray-100 px-4 py-3 flex items-center justify-between border-b border-gray-50"
            >
